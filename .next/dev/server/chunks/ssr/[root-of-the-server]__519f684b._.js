...
const projects = [
    {
        ...
        description: "Role-based admin dashboard for orders, stock, and reporting with fast search and analytics.",
        tech: [
            "Next.js",
            "TypeScript",
            "PostgreSQL",
        ...
        metrics: [
            "Reduced report time by 60%",
            "1s average search response"
        ],
        featured: true,
        links: [
            {
    ...
    },
    {
        ...
        description: "Internal tool to generate SEO-friendly product content with templates and quality checks.",
        tech: [
            "Next.js",
            "Node.js",
            "OpenAI",
        ...
        links: [
            {
                label: "GitHub",
                href: "https://github.com/your-username/repo2"
            }
        ]
    }
];
